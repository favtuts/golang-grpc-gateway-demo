...
2024/09/17 14:37:39 Serving gRPC on connection :2002
2024/09/17 14:37:39 Serving gRPC-Gateway on connection :5002
```

Then we use cURL to send HTTP requests:
```bash
$ curl --location --request POST 'http://localhost:5002/v1/message' \
